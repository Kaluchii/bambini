<li class="group" data-group-id="{{$educators->id_field}}">
    <div class="title-block">
        ...
        <button type="button" class="any_delete" data-block="dom_target_upgrade" data-group="target_program_educators"
    ...
    <div class="block">
        <div class="field-wrap">
            <select data-field-name="educator_id"
                    ...
                    data-block="dom_target_upgrade" data-group="target_program_educators" class="input group_field"
        ...
        <div class="field-wrap buttons">
            <button type="button" class="any_save" data-block="dom_target_upgrade" data-group="target_program_educators"
